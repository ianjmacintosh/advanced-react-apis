...
<EpicVideo url="https://www.epicreact.dev/workshops/advanced-react-apis/state-object" />

👨‍💼 Back in the days of class components, we had `this.setState`. We're going to
